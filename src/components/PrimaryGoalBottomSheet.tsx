...
import type { PrimaryGoalBottomSheetProps } from './PrimaryGoalBottomSheet.types';

export const PrimaryGoalBottomSheet = ({
  visible,
  onClose,
  initialValue,
  onSelect,
}: PrimaryGoalBottomSheetProps): ReactElement => {
  ...
  return (
    <BottomSheet
      visible={visible}
      onClose={onClose}
      header={{ title: translation.primaryGoalHeaderTitle }}
      footer={{
