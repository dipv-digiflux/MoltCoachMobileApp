...
export const typographyByWeight = {
  ...
  h10Tight: withWeights(typographyTokens.h10Tight),
  b1: withWeights(typographyTokens.b1),
  bodySmall1: withWeights(typographyTokens.bodySmall1),
  bodySmall1Tall: withWeights(typographyTokens.bodySmall1Tall),
...
export const typography = {
  ...
  h10TightBold: typographyByWeight.h10Tight.bold,
  h10TightSemiBold: typographyByWeight.h10Tight.semiBold,
  h10TightMedium: typographyByWeight.h10Tight.medium,
  h10TightRegular: typographyByWeight.h10Tight.regular,
  ...
  bodySmall1TallBold: typographyByWeight.bodySmall1Tall.bold,
  bodySmall1TallSemiBold: typographyByWeight.bodySmall1Tall.semiBold,
  bodySmall1TallMedium: typographyByWeight.bodySmall1Tall.medium,
  bodySmall1TallRegular: typographyByWeight.bodySmall1Tall.regular,
